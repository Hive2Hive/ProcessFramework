...
public class SyncProcessTest extends BaseTest {
	...
	public static void initTest() throws Exception {
		testClass = SyncProcessTest.class;
		beforeClass();
	}
	...
	public void testAwaitAsyncExecutionSuccess() {
		...
		assertTrue(proc.getState() == ProcessState.EXECUTION_SUCCEEDED);
		assertTrue(asyncComp.getState() == ProcessState.EXECUTION_SUCCEEDED);
	}
	
	@Test
	public void testAwaitAsyncExecutionFail() {
		
		SyncProcess proc = TestUtil.executionSuccessSyncProcess();
		
		IProcessComponent<Void> busyComp = new BusyComponent(TestUtil.executionFailComponent(true));
		IProcessComponent<?> asyncComp = new AsyncComponent<Void>(busyComp);
		proc.add(asyncComp);
		...
		assertTrue(proc.getState() == ProcessState.EXECUTION_FAILED);
		assertTrue(asyncComp.getState() == ProcessState.EXECUTION_FAILED);
	}
